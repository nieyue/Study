 ...
 */
public class NieyueHandler extends URLStreamHandler {
    /**
     * 当URL根据协议找到该处理器并调用openConnection()方法后，返回负责处理该协议连接的连接器
     * @param u
     * @return
     * @throws IOException
     */
    ...
    protected URLConnection openConnection(URL u) throws IOException {
        return new NieyueURLConnection(u);
    }
}
